                  ...
                  <div class="tab-pane fade" id="privateinfo" role="tabpanel" aria-labelledby="privateinfo-tab">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            {!! Form::textarea('privateinfo_caregiver_responsibilities', null, ['class' => 'resizable_textarea form-control']) !!}<br>
                        </div><br>
                    </div><br>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 ">Caregiver Requirements</label>
                        <div class="col-md-9 col-sm-9 ">
                            {!! Form::textarea('privateinfo_caregiver_requirements', null, ['class' => 'resizable_textarea form-control']) !!}<br>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 ">Notes</label>
                        <div class="col-md-9 col-sm-9 ">
                            {!! Form::textarea('privateinfo_caregiver_notes', null, ['class' => 'resizable_textarea form-control']) !!}<br>
                        </div><br>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 ">Raferral Code Signup</label>
                        <div class="col-md-9 col-sm-9 ">
                            {!! Form::textarea('privateinfo_caregiver_referrel_code', null, ['class' => 'resizable_textarea form-control']) !!}<br>
                        </div>
                    </div>
                  </div>
